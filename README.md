...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/MarciaCondarco/blogpessoal_spring_t83) dentro da pasta do *Workspace* do STS
 
```bash
git clone https://github.com/MarciaCondarco/blogpessoal_spring_t83.git
```
